...
function Score-File {
    ...
    $score = 0
    # Optimisation: Use native string methods for faster matching (no regex overhead)
    if ($Path.IndexOf('Test', [System.StringComparison]::OrdinalIgnoreCase) -ge 0 -or $Path.IndexOf('Tests', [System.StringComparison]::OrdinalIgnoreCase) -ge 0) { $score += 50 }
    if ($Path.IndexOf('Service', [System.StringComparison]::OrdinalIgnoreCase) -ge 0 -or
        ...
        $Path.IndexOf('Repository', [System.StringComparison]::OrdinalIgnoreCase) -ge 0 -or
        $Path.IndexOf('Repo', [System.StringComparison]::OrdinalIgnoreCase) -ge 0) { $score += 15 }
    ...
    if ($Path.IndexOf('Module', [System.StringComparison]::OrdinalIgnoreCase) -ge 0 -or
        ...
        $Path.IndexOf('Agent', [System.StringComparison]::OrdinalIgnoreCase) -ge 0) { $score += 15 }
    ...
    if ($Path.IndexOf('Program', [System.StringComparison]::OrdinalIgnoreCase) -ge 0 -or
        $Path.IndexOf('Startup', [System.StringComparison]::OrdinalIgnoreCase) -ge 0) { $score -= 10 }
